export PATH=/opt/homebrew/bin:~/.dotfiles:~/Library/Android/sdk/platform-tools:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Library/Apple/usr/bin:~/Library/Python/3.x/bin:~/lua-5.x.x/src:~/usr/local/Caskroom/flutter/2.x.x/flutter/bin/:~/.dotnet/tools:~/imageoptim-cli/dist:/opt/homebrew/Cellar/lua-language-server/2.5.3/libexec/bin/macOS/lua-language-server
