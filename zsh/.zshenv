export PATH=/opt/homebrew/opt/ruby/bin:/opt/homebrew/bin:~/.dotfiles:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Library/Apple/usr/bin:~/Library/Android/sdk/platform-tools:~/Library/Python/3.x/bin:~/usr/local/Caskroom/flutter/2.x.x/flutter/bin/:~/.dotnet/tools:~/imageoptim-cli/dist:/opt/homebrew/Cellar/lua-language-server/2.x.x/libexec/bin/macOS/lua-language-server:/Library/Frameworks/Mono.framework/Versions/Current/bin
