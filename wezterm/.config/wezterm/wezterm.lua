...
wezterm.on("change_wallpapper", function(window, _)
	math.randomseed(os.time())
	local anime = math.random(22)
	local overrides = window:get_config_overrides() or {}
	overrides.window_background_image = "./wallpappers/" .. anime .. ".jpg",
...
return {
	...
	window_background_image = "./wallpappers/4.jpg",
	...
	keys = {
		...
		{ key = "t", mods = "CMD|SHIFT", action = wezterm.action{EmitEvent = "change_wallpapper"} },
