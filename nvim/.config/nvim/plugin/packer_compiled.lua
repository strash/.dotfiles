...
_G.packer_plugins = {
  LuaSnip = {
    loaded = true,
    path = "/Users/strash/.local/share/nvim/site/pack/packer/start/LuaSnip",
  ...
  ["cmp-nvim-lsp-signature-help"] = {
    loaded = true,
    path = "/Users/strash/.local/share/nvim/site/pack/packer/start/cmp-nvim-lsp-signature-help",
